...
def test_vlc(video: Path):
    print("Starting VLC for test")
    subprocess.Popen(["C:/Program Files/VideoLAN/VLC/vlc.exe", video, "-R"])
    return print("Successfully started VLC test")
...
# def switch_video(temp_final_video: Path, final_video: Path, vlc_alive: bool):
#     if vlc_alive:
#         kill_vlc()
#     final_video
